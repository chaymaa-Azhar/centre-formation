...
<head>
    ...
    <style>
        ...
        .sidebar { min-height: 100vh; background: #343a40; color: white; padding-top: 20px; position: fixed; width: 250px; transition: background 0.3s; }
        .theme-toggle.active { background-color: rgba(0,0,0,0.1); border-color: rgba(0,0,0,0.2) !important; color: #198754 !important; }
        [data-bs-theme="dark"] .theme-toggle.active { background-color: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2) !important; color: #2ecc71 !important; }
